...
class weather:
   ...
   def __init__(self, root):
       ...
       self.today = forecast(root["item"][0])
       self.forecastday1 = forecast(root["item"][1])
       self.forecastday2 = forecast(root["item"][2])
       self.forecastday3 = forecast(root["item"][3])
       self.forecastday4 = forecast(root["item"][4])
   def getCountry(self):
       return self.country
   def getRegion(self):
       return self.region
